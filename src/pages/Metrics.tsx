...
export default function Metrics() {
  ...
  const compliance = (clients.data ?? []).map((client) => ({ name: client.code, conformidade: statusForClient(client, activeTypes, allRecords, config).score })).sort((a, b) => a.conformidade - b.conformidade);
